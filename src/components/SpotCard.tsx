...
export default function SpotCard({
  name, host, distance, price, rating, reviews, isOpen, isVerified, isFeatured, image, onBook
}: SpotCardProps) {
  const { user } = useAuth();
      ...
      <div className="p-5">
        ...
        <div className="flex gap-2">
          <button
            ...
            className="flex-1 px-4 py-2.5 rounded-xl bg-primary text-primary-foreground text-sm font-semibold hover:bg-primary/90 transition-all"
          >
            Book Now
          </button>
          <a
